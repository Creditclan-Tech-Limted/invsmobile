            ...
            child: Column(
              ...
              children: [
                ...
                PrimaryBlockButton(
                  text: "Invest Now",
                  press: () {
                    Navigator.pushNamed(context, ProductDetailMore.routeName);
                  },
                ),
        ...
        AnimatedContainer(
            ...
            decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.only(
                  topLeft: Radius.circular(getProportionateScreenHeight(45)),
                  topRight: Radius.circular(getProportionateScreenHeight(45)),
                )),
            child: Container(
              margin: EdgeInsets.fromLTRB(
                  getProportionateScreenWidth(24),
                ...
                children: [
                  ...
                  Container(
                    ...
                    padding: EdgeInsets.fromLTRB(
                        ...
                        getProportionateScreenHeight(30)),
                    child: Text(
                        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Enim ipsum id orci ipsum scelerisque diam at consectetur. Nulla egestas gravida ac eu. Nibh elit amet, in orci lacus massa convallis senectus. Vivamus accumsan pretium massa libero, arcu lacus ultrices ipsum posuere.",
                        style: TextStyle(
                          letterSpacing: 1,
                          color: kTextColorGrey,
                          fontFamily: "Poppins",
